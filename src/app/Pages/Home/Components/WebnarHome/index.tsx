...
export default function WebnarHome() {
    ...
    return (
        <section className="w-full h-auto lg:h-[90vh] bg-cover flex items-center justify-center bg-center bg-no-repeat bg-custom-linear  pt-[100px] ">
            <div className="w-[90%] lg:w-full max-w-[1200px] gap-10  h-full flex lg:flex-row flex-col items-center justify-between">
                <div className="lg:w-1/2 flex gap-3 flex-col h-auto">
                    ...
                    <p className="text-white">
                        Garanta o uso correto e completo do Ondetah, inserindo suas novas funcionalidades na rotina operacional da sua equipe. Neste treinamento, oferecemos um guia completo do produto e estratégias de implementação, sem depender da disseminação por um Key User.
                    </p>
